...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2020 a las 01:39:49
...
(1, 'reloj', '0007-a', 1200000, '15kg', 1, 2, '2020-06-10', '2020-06-11 10:34:19');
...
ALTER TABLE `producto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fck_categoria` (`categoria`);
...
--
ALTER TABLE `producto`
  ADD CONSTRAINT `fck_categoria` FOREIGN KEY (`categoria`) REFERENCES `categoria` (`idcategoria`);
COMMIT;
